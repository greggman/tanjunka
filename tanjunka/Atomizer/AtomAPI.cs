...
namespace Atomizer
{
    ...
    public class Atom
    {
        ...
        /// <summary>
        /// Atom::GetBlogEntry: GETs the specified entry
        /// Use the service.edit URL to do the edit
        /// </summary>
        public entryType GetBlogEntry(string editURL)
        {
            dbg.TraceIn();

            XmlTextReader xmlText = PostToATOMAPI(postType.Get, editURL, null, null, null);
            XmlSerializer serializer = new XmlSerializer(typeof(entryType));
            serializer.UnknownElement += new XmlElementEventHandler(Serializer_contentType);
    ...
    public class TypePad : Atom
    {
        ...
        /// GetCategories: Returns string array of TypePad categories
        /// </summary>
        new public string[] GetCategories(string catURL)
        {
            dbg.TraceIn();
    ...
    public class entryType
    {
        ...
        [System.Xml.Serialization.XmlElementAttribute("subject", Namespace="http://purl.org/dc/elements/1.1/")] //  xmlns:dc="http://purl.org/dc/elements/1.1/">

...
namespace NetSpell.SpellChecker
{
    ...
    public class Spelling : System.ComponentModel.Component
    {
        ...
        private Regex _htmlRegex = new Regex(@"</[c-g\d]+>|</[i-o\d]+>|</[a\d]+>|&\w+;|</[q-z\d]+>|<[cg]+[^>]*>|<[i-o]+[^>]*>|<[q-z]+[^>]*>|<[a]+[^>]*>|<(\[^\]*\|'[^']*'|[^'\>])*>", RegexOptions.IgnoreCase & RegexOptions.Compiled);
        ...
        private Regex _wordEx = new Regex(@"\b[\w_']+\b", RegexOptions.Compiled);

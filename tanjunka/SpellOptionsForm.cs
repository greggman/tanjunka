...
namespace Tanjunka
{
    ...
    /// </summary>
    internal class SpellOptionsForm : System.Windows.Forms.Form
    {
        ...
        ///     Default Constructor
        /// </summary>
        public SpellOptionsForm(ref Spelling spell)
        {
        ...
        private void OptionForm_Load(object sender, System.EventArgs e)
        {
            ...
            AssemblyInfo aInfo = new AssemblyInfo(typeof(SpellOptionsForm));

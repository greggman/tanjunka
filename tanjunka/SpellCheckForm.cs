...
namespace Tanjunka
{
    ...
    /// </summary>
    public class SpellCheckForm : System.Windows.Forms.Form
    {
        ...
        ///     Default Constructor
        /// </summary>
        public SpellCheckForm(Spelling spell)
        {
        ...
        {
            SpellOptionsForm options = new SpellOptionsForm(ref this.SpellChecker);
        ...
        {
            System.Resources.ResourceManager resources = new System.Resources.ResourceManager(typeof(SpellCheckForm));
        ...
        private void SpellChecker_EndOfText(object sender, System.EventArgs e)
        {
            ...
            {
                MessageBox.Show(this, Localize.G.GetText("SpellCheckComplete"), Localize.G.GetText("SpellCheck"),
        ...
        private void UpdateDisplay(string text, string word, int wordIndex, int textIndex)
        {
            ...
            if(word.Length > 0)
            {
                string b4 = Util.StripHTML(text.Substring(0, textIndex));
                //highlight current word
                this.TextBeingChecked.AppendText(b4);
                this.TextBeingChecked.SelectionColor = Color.Red;
                this.TextBeingChecked.AppendText(Util.StripHTML(word));
                this.TextBeingChecked.SelectionColor = Color.Black;
                this.TextBeingChecked.AppendText(Util.StripHTML(text.Substring(textIndex + word.Length)));

                //set caret and scroll window
                this.TextBeingChecked.Select(b4.Length, 0);
                this.TextBeingChecked.Focus();
                this.TextBeingChecked.ScrollToCaret();
            }
            else
            {
                this.TextBeingChecked.AppendText(Util.StripHTML(text));
            }
